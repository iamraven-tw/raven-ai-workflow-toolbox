...
| 2 | `website-content-writing` | 依設定檔撰寫價值主張、服務、關於、行動呼籲與初始文章；標記哪些句子是使用者提供的事實、哪些是 AI 建議 | 批次確認文案，修正事實 | 是 |
...
flowchart LR
    ...
    A --> H2([人：批次確認])
    H2 --> B[website-content-writing<br/>Agent 撰寫文案]
